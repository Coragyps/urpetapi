...
public interface iReservaRepository extends JpaRepository<Reserva, Integer> {
    ...
    public void Estado(@Param("idreserva") Integer idreserva, @Param("estado") String estado);
    ...
    public List<Reserva> TodoUsuario(@Param("idusuario") int idusuario);
    ...
    public List<String[]> PaseosporCliente(@Param("idpaseador") int idpaseador);
}
